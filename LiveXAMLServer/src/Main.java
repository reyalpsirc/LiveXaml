		...
		if (args.length>0){
			...
			if (args.length>1){
				try{
					...
					System.out.println("\""+args[1].toString()+"\" is not a valid port.");
					return;
				}
			}
			...
			System.out.println("Usage: java -jar LiveXaml.jar /path/to/MyPage.xaml [port]");
		}
	}
